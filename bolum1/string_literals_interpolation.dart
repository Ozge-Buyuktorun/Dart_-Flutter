...
main(List<String> args) {
  ...
  var kurs = 'Dart\'ın Kullanımı';   //   / escape işareti kullanımı.
  String kursTanimi = "Dart'ı ve Flutter'ı Öğreneceğiz";

  print(isim + " " + soyIsim); // bu tercih edilen birşey değil.
  print("$isim $soyIsim"); // interpolation deniyor.
  print("soyadım olan $soyIsim'te bulunan karakter sayısı:" +
      soyIsim.length.toString());   // stringe dönüştürerek text + text birleşir.
  print("Karakter sayısı ${soyIsim.length}");  //ifade birden fazla ifade içeriyorsa {} gruplama yapmak lazım.
